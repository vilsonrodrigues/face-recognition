...
class PipelineRetrievalLogic:
    ...
    async def route(
        ...
        if len(relative_boxes) == 0:
            ...
            faces_and_boxes_rescaled_ref: DeploymentResponse = self._face_postp.apply.remote(relative_boxes, image)
            ...
            tasks = [self._neural_search.search.remote(self._face_emb.predict.remote(face)) for face in faces_and_boxes_rescaled['faces']]
